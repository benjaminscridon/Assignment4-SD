	...
	class PostActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!("".equals(firstname) || "".equals(lastname) || "".equals(mail))) {
				...
				try {
					// encode the request: a POST request, at the url "student",
					// sending the student object
					...
					// if server responded OK, then operation was successful,
					// else display error
	...
	class GetActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			try {
				...
				// encode the request: a GET request, with url "student?id=X"
