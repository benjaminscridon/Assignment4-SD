...
public class LoginServiceLocator extends org.apache.axis.client.Service implements LoginService {
    ...
    private java.lang.String LoginServiceSoap_address = "http://localhost:50499/LoginService.asmx";
    ...
    public LoginServiceSoap getLoginServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public LoginServiceSoap getLoginServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            LoginServiceSoapStub _stub = new LoginServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (LoginServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                LoginServiceSoapStub _stub = new LoginServiceSoapStub(new java.net.URL(LoginServiceSoap_address), this);
                _stub.setPortName(getLoginServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        if ("LoginServiceSoap".equals(inputPortName)) {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://net.login/", "LoginService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://net.login/", "LoginServiceSoap"));
        }
